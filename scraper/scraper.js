...
export async function scrapeData(url) {
  ...
  const returningFlight = {
    originCode: await page.waitForXPath('(//div[contains(@class, "ZHa2lc tdMWuf y52p7d")]//span[contains(@dir, "ltr") and normalize-space()])[2]')
      .then(element => page.evaluate(el => el.textContent.trim(), element)),
    departureDate: await page.waitForSelector('div:nth-child(2) > div.uQEzCd > div > div > div.tMLpW')
      .then(element => page.evaluate(el => el.textContent.trim(), element)),
    departureTime: await page.waitForSelector('#c35 > div.c257Jb.QwxBBf.NbfThf > div.b0EVyb.YMlIz.y52p7d, #c41 > div.c257Jb.QwxBBf.NbfThf > div.b0EVyb.YMlIz.y52p7d, #c51 > div.c257Jb.QwxBBf.NbfThf > div.b0EVyb.YMlIz.y52p7d, #c53 > div.c257Jb.QwxBBf.NbfThf > div.b0EVyb.YMlIz.y52p7d')
      .then(element => page.evaluate(el => el.textContent.replace(/\+1$/, "").trim(), element)),
    destinationCode: await page.waitForXPath('(//div[contains(@class, "FY5t7d tdMWuf y52p7d")]//span[contains(@dir, "ltr") and normalize-space()])[2]')
      .then(element => page.evaluate(el => el.textContent.trim(), element)),
